...
andmed$valiidne <- NA # kommentaar pärast veebipraktikumi: praktikumis tekkis tunnuse andmed$valiidne arvutamisel probleem - antud käsk oleks tulnud tegelikult vahele jätta, st seda poleks pidanud siin olema, selle tõttu läheb andmelünkade arvestamine järgnevates käskudes aia taha
